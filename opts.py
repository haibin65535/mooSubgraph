...
def parse_args(jupyter = False):
    ...
    parser.add_argument('--ge', type=float, default=1)
    ...
    parser.add_argument('--data_root', type=str, default="/home/zz/wenhaibin/CAL/CAL-sp/")
    parser.add_argument('--save_dir', type=str, default="debug")
    parser.add_argument('--dataset', type=str, default="mnistsp")
    parser.add_argument('--epoch_select', type=str, default='test_max')
    parser.add_argument('--model', type=str, default="CaseGCN", help="GCN, GIN")
...
def get_model(args):
    ...
    elif args.model == "CaseGCN":
        model_func = model_func4
    elif args.model == "CaseGIN":
        model_func = model_func5
    elif args.model == "CaseGAT":
